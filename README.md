...
- 📦🆓💰 [OpenSOSData](https://github.com/OpenSOSData/opensosdata-mcp) — US business entity search across all 53 Secretary of State jurisdictions (50 states, DC, Puerto Rico, US Virgin Islands): name search, status checks and batch lookups over a 33M-entity index. First 10 lookups free on signup, then from $0.0314 each. `npx -y @opensosdata/mcp-server`
